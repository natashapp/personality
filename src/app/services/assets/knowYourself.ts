...
const knowYourselfTest: Test = {
    "id": "20",
    "name": "Know yourself",
    "className": "know",
    "_productId": "com.sofisapps.personality.KnowYourself",
    ...
    "questions": [{
        ...
        "answers": [{
            ...
            "id": "2",
            "name": "A yellow cornfield against a brilliant blue sky",
        ...
        "answers": [{
            ...
            "id": "3",
            "name": "A river",
            "text": "You have very sensible tactics when approaching the opposite sex. In many ways people find your straightforwardness attractive, so you will find yourself with plenty of dates."
        }]
    }, {
        "id": "5",
        ...
        "id": "6",
        "name": "Next, you stumble across a house. What type of house is it?",
        ...
        "answers": [{
            ...
            "text": "You are afraid of failure and scared to have a go at the career you would like to have in case you don't succeed. Don't give up when you haven't even started yet! Be courageous!"
        }, {
            "id": "2",
        ...
        "id": "9",
        "name": "Because you are so scared, you run until you see a wall blocking the path in front of you. There is a door, but it's locked, so you peek through the keyhole. What do you see?",
        "means": "Who is your true self?",
        "message": undefined,
        "answers": [{
            "id": "1",
            "name": "A beautiful house with a vast garden",
            "text": "You are mature, reasonable, and honest and give good advice. People ask for your comments on all sorts of different issues. Sometimes you might find yourself in a dilemma when trapped with a problem, which your heart rather than your head needs to solve."
        }, {
            "id": "2",
