...
const walkingTest: Test = {
    "id": "19",
    "name": "Walking",
    "className": "walking",
    "_productId": "com.sofisapps.personality.Walking",
    ...
    "questions": [{
        ...
        "answers": [{
            "id": "1",
            "name": "Only red",
            "text": "When you analyze your relationship, your main focus is on how much you are giving in a relationship."
        }, {
            "id": "2",
            "name": "Only white",
            ...
            "id": "3",
            "name": "Half and half",
            "text": "When you analyze your relationship, you are focused on the balance; you expect that your giving is equally met from the other party. You expect a balanced relationship."
        }, {
            "id": "4",
            "name": "More red than white",
            "text": "When you analyze your relationship, you are more focused on how much you give. You are not concerned if your giving is not equally met by the other party."
        }, {
            "id": "5",
        ...
        "means": "The attitude in handling relationship problems",
        "message": undefined,
        "answers": [{
            "id": "1",
            "name": "Ask the maid",
            "text": "You are avoiding a direct approach to solving relationship problems. You feel that you are right, but you like when there is a third party involved reassuring you. You care about other people's opinions in solving your type of problem."
        }, {
            "id": "2",
            "name": "Do it yourself",
        ...
        "answers": [{
            ...
            "text": "Placing the roses by the window shows that you don't expect or need to see your loved one too often."
        }]
        ...
        "answers": [{
            "id": "1",
            "name": "Awake",
            "text": "You accept your loved one just as they are."
        }, {
            "id": "2",
            "name": "Sleeping",
            "text": "You expect him/her to change for you."
        }]
